...
# (location of tool-path file reflects Dualcam-Companion software structure)
if { 0 == [raw_to_hdr_main "-inp_dirs {L} -out_subdir_name OUT -final_depth 8 -raw_ext ARW -rotate 0  -wb_out_file wb_left.csv $INP_WB_OVRD   -tools_paths_file [dualcam_find_toolpaths_file 0] -do_skip_existing 0"]}   {
  return  0;  # error already printed
}
...
# (location of tool-path file reflects Dualcam-Companion software structure)
if { 0 == [raw_to_hdr_main "-inp_dirs {R} -out_subdir_name OUT -final_depth 8 -raw_ext ARW -rotate 0  -wb_out_file wb_right.csv -wb_inp_file wb_ovrd_right.csv  -tools_paths_file [dualcam_find_toolpaths_file 0] -do_skip_existing 0"] }   {
  return  0;  # error already printed
}
